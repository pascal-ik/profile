...
import pamtech.com.mycustomview.R;
...
public class LovelyView extends View {
    ...
    public LovelyView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public LovelyView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
