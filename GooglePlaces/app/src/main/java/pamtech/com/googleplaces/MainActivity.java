package pamtech.com.googleplaces;
...
import pamtech.com.googleplaces.adapters.NearByPlacesAdapter;
import pamtech.com.googleplaces.models.NearBy;
import pamtech.com.googleplaces.remote.GoogleApiClient;
import pamtech.com.googleplaces.remote.GoogleApiInterface;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void fetchNearByPlaces() {
        ...
        mCompositeDisposable.add(mGoogleApiInterface.getNearByPlaces(mCurrentLocation, 50, KEY)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Consumer<NearBy>() {
                    @Override
                    public void accept(NearBy nearBy) throws OnErrorNotImplementedException {
                        try {
                            Log.d(TAG, "accept: show response" + nearBy.toString());
                            displayNearByPlaces(nearBy);
    ...
    private void displayNearByPlaces(NearBy nearBy) {
...
/*        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    private void buildGoogelApiClient() {
